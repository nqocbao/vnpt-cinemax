            ...
            <div className="bg-white col-span-4 lg:shadow-2xl rounded px-3 md:px-8 py-10 space-y-6">
               ...
               <div className='space-y-6 my-20 '>
                ...
                <div className='flex justify-between'>
                    <h3 className='font-semibold text-sm md:text-base'>HOTLINE hỗ trợ: <span className='text-blue-700'>19002224 (9:00 - 22:00)</span></h3>
                    <ChevronRight className='text-gray-500 w-5 h-5'/>
                </div>
                <div className='border border-[#ccc]'></div>
                <div className='flex justify-between'>
                    <h3 className='font-semibold text-sm md:text-base'>Email: <span className='text-blue-700'>hotro@cinemaxstudio.vn</span></h3>
                    <ChevronRight className='text-gray-500 w-5 h-5'/>

                </div>
                <div className='border border-[#ccc]'></div>
                <div className='flex justify-between'>
                    <h3 className='font-semibold text-sm md:text-base'>Câu hỏi thường gặp</h3>
                    <ChevronRight className='text-gray-500 w-5 h-5'/>
            ...
            <div className="bg-white col-span-8 lg:shadow-2xl rounded px-3 md:px-8 p-10">
                <Tabs defaultValue="profile" className="w-full">
                    <TabsList className='flex flex-wrap flex-row justify-between w-full my-6'>
                        ...
                        <TabsTrigger value="notify" className='!shadow-none text-base text-lg text-gray-500 data-[state=active]:text-[#8B008B] cursor-pointer hidden md:flex'>Thông Báo</TabsTrigger>
                        <TabsTrigger value="reward" className='!shadow-none text-base text-lg text-gray-500 data-[state=active]:text-[#8B008B] cursor-pointer hidden md:flex'>Quà Tặng</TabsTrigger>
                        <TabsTrigger value="policy" className='!shadow-none text-base text-lg text-gray-500 data-[state=active]:text-[#8B008B] cursor-pointer hidden md:flex'>Chính Sách</TabsTrigger>
                    </TabsList>
                                ...
                                <div className="relative">
                                    ...
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <Button className='absolute text-[#8B008B] right-2 top-1/2 -translate-y-1/2 px-3 py-1 text-xs cursor-pointer'>Thay đổi</Button>
                                        </DialogTrigger>
                                        <DialogContent className='bg-white'>
                                            ...
                                            <DialogDescription className='space-y-4'>
                                                <p>Vui lòng cung cấp email mới, chúng tôi sẽ gửi mã xác thực cho bạn!</p>
                                            ...
                                            <DialogFooter>
                                                <Button className='w-full bg-[#8B008B] text-white cursor-pointer hover:opacity-80'>TIẾP TỤC</Button>
                                            </DialogFooter>
                                        </DialogContent>
                                    </Dialog>
                                </div>
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className='bg-white'>
                                            ...
                                            <DialogDescription className='space-y-4'>
                                                ...
                                                <Label htmlFor="password" className="my-2 text-gray-500">
                                                    <span className="text-red-600">*</span> Mật khẩu hiện tại
                                                </Label>
                                                <div className='relative'>
                                                    <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4" />
                                                    <Input
                                                ...
                                                <Label htmlFor="password" className="my-2 text-gray-500">
                                                    <span className="text-red-600">*</span> Mật khẩu mới
                                                </Label>
                                                <div className='relative'>
                                                    <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4" />
                                                    <Input
                                                ...
                                                <Label htmlFor="password" className="my-2 text-gray-500">
                                                    <span className="text-red-600">*</span> Xác nhận mật khẩu mới
                                                </Label>
                                                <div className='relative'>
                                                    <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4" />
                                                    <Input
                                            ...
                                            <DialogFooter>
                                                <Button className='w-full bg-[#8B008B] text-white cursor-pointer hover:opacity-80'>CẬP NHẬT</Button>
                                            </DialogFooter>
                                        </DialogContent>
                                    </Dialog>   
                                </div>
