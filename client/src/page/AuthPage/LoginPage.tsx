  ...
  return (
    <div className="flex w-screen h-screen items-center justify-center ">
      <Tabs defaultValue="login" className="w-full max-w-[560px] min-h-[400px] mx-auto px-2">
        ...
        {/* Login */}
        <TabsContent value="login" className="space-y-6 p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-2 mb-8">
                ...
                <div className="relative">
                  ...
                  <SelectContent className="z-50 max-h-[100px] overflow-y-auto bg-white shadow-md">
                    <SelectItem value="boy" className="hover:bg-blue-600 hover:text-white">Nam</SelectItem>
                    <SelectItem value="girl" className="hover:bg-blue-600 hover:text-white">Nữ</SelectItem>
                    <SelectItem value="other" className="hover:bg-blue-600 hover:text-white">Khác</SelectItem>
                  </SelectContent> 
                </Select>
                </div>
              </div>
